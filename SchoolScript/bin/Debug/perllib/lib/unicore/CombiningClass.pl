...
#         Canonical_Combining_Class(cp)
#         Ccc(cp)
# 
# where 'cp' is one of the 653 code points in Unicode Version 6.1.0 for which
# the mapping is not to '0'.  Note that these mappings are accessible via the
# function prop_invmap('Canonical_Combining_Class') in Unicode::UCD
# 
