...
#         Age(cp)
# 
# where 'cp' is one of the 249_763 code points in Unicode Version 6.1.0 for
# which the mapping is not to 'Unassigned'.  Note that this mapping is
# accessible via the function prop_invmap('Age') in Unicode::UCD
# 
