...
#         Category(cp)
# 
# where 'cp' is one of the 249_697 code points in Unicode Version 6.1.0 for
# which the mapping is not to 'Cn'.  Note that these mappings are accessible
# via the function prop_invmap('General_Category') in Unicode::UCD
# 
