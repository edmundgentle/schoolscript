...
#         Lc(cp)
# 
# where 'cp' is one of the 1044 code points in Unicode Version 6.1.0 for
# which the mapping is not to itself.  Note that these mappings are
# accessible via the function prop_invmap('Lowercase_Mapping') in Unicode::UCD
# 
