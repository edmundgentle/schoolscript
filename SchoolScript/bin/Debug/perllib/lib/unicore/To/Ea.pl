...
#         Ea(cp)
# 
# where 'cp' is one of the 312_301 code points in Unicode Version 6.1.0 for
# which the mapping is not to 'Neutral'.  Note that these mappings are
# accessible via the function prop_invmap('East_Asian_Width') in Unicode::UCD
# 
