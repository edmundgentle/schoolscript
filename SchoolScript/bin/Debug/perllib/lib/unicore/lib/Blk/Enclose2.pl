...
# 
# This file returns the 160 code points in Unicode Version 6.1.0 that match
# any of the following regular expression constructs:
# 
#         \p{Block=Enclosed_Alphanumerics}
#         \p{Blk=Enclosed_Alphanum}
# 
# X       \p{Enclosed_Alphanumerics}
# X       \p{Is_Enclosed_Alphanumerics}
#         \p{In_Enclosed_Alphanumerics}
# X       \p{Enclosed_Alphanum}
# X       \p{Is_Enclosed_Alphanum}
#         \p{In_Enclosed_Alphanum}
# 
