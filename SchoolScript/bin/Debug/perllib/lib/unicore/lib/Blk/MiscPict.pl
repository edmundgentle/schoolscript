...
# 
# This file returns the 768 code points in Unicode Version 6.1.0 that match
# any of the following regular expression constructs:
# 
#         \p{Block=Miscellaneous_Symbols_And_Pictographs}
#         \p{Blk=Misc_Pictographs}
# 
...
# X       \p{Misc_Pictographs}
# X       \p{Is_Misc_Pictographs}
#         \p{In_Misc_Pictographs}
# 
