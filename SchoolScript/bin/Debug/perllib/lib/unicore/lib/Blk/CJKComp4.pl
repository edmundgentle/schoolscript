...
# 
# This file returns the 544 code points in Unicode Version 6.1.0 that match
# any of the following regular expression constructs:
# 
#         \p{Block=CJK_Compatibility_Ideographs_Supplement}
#         \p{Blk=CJK_Compat_Ideographs_Sup}
# 
...
# X       \p{Is_CJK_Compat_Ideographs_Sup}
#         \p{In_CJK_Compat_Ideographs_Sup}
# 
