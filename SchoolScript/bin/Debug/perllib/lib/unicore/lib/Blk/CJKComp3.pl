...
# 
# This file returns the 512 code points in Unicode Version 6.1.0 that match
# any of the following regular expression constructs:
# 
#         \p{Block=CJK_Compatibility_Ideographs}
#         \p{Blk=CJK_Compat_Ideographs}
# 
# X       \p{CJK_Compatibility_Ideographs}
# X       \p{Is_CJK_Compatibility_Ideographs}
#         \p{In_CJK_Compatibility_Ideographs}
# X       \p{CJK_Compat_Ideographs}
# X       \p{Is_CJK_Compat_Ideographs}
#         \p{In_CJK_Compat_Ideographs}
# 
