...
# 
# This file returns the 16 code points in Unicode Version 6.1.0 that match
# any of the following regular expression constructs:
# 
#         \p{Block=Sundanese_Supplement}
#         \p{Blk=Sundanese_Sup}
# 
# X       \p{Sundanese_Supplement}
# X       \p{Is_Sundanese_Supplement}
#         \p{In_Sundanese_Supplement}
# X       \p{Sundanese_Sup}
# X       \p{Is_Sundanese_Sup}
#         \p{In_Sundanese_Sup}
# 
